            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php if ($user): ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-heart p-1"></i>Favorites</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"> <i class="bi bi-bag p-1"></i>Bag</a></li>
                    <?php else: ?>
