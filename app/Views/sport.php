...
<header class="text-white text-center py-5"
    style="background: url('https://images.unsplash.com/photo-1676145463818-2550e1ff1819?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTA2fHxtZW4lMjBmYXNoaW9ufGVufDB8fDB8fHww') no-repeat center center; background-size: cover;">
    <div class="container">
        <h1 class="display-4">Discover Our Latest Cloth's Styles for <span>Sport</span></h1>
        <p class="lead">Stylish Looks for Every Occasion</p>
    </div>
</header>
...
<?php if (!empty($sport)): ?>
  ...
  <header class="text-success text-center py-5"
        style="background: url('https://images.unsplash.com/photo-1608825961330-74de870da2d0?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjY5fHxtZW4lMjBmYXNoaW9ufGVufDB8fDB8fHww') no-repeat center center; background-size: cover; opacity: 0.7;">
        <div class="container">
