...
<header class="text-success text-center py-5 mb-12" style="height: 200px; width: auto;">
    <div class="container flex flex-col sm:flex-row items-center justify-between h-full">
